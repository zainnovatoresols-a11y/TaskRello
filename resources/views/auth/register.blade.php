<style>
    ...
    .lx-f4 {
        animation: fade-up 0.7s 0.50s cubic-bezier(0.22, 1, 0.36, 1) both;
    }
    ...
    .lx-l4 {
        animation: line-grow 0.7s 0.55s cubic-bezier(0.22, 1, 0.36, 1) both;
    }
    ...
    <div class="lx-shell fixed inset-0 flex items-center justify-center overflow-hidden"
        ...
        <div class="relative z-10 w-full max-w-[480px] px-10 text-center sm:px-6">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-field lx-f1 flex items-end gap-4 mb-7">
                ...
                <div class="form-field lx-f2 flex items-end gap-4 mb-7">
                    <div class="flex-shrink-0 w-5 h-5 mb-2.5 text-neutral-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="form-field lx-f3 flex items-end gap-4 mb-2">
                    <div class="flex-shrink-0 w-5 h-5 mb-2.5 text-neutral-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="form-field lx-f4 flex items-end gap-4 mb-9">
                    <div class="flex-shrink-0 w-5 h-5 mb-2.5 text-neutral-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
